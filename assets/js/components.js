...
(function () {
  ...
  const NAV_ITEMS = [
    ...
    { label: 'Legislative Work', href: 'legislative-work', page: 'legislative' },
    { label: 'Achievements', href: 'achievements', page: 'achievements' },
    { label: 'Issues & Policy', href: 'issues-policy', page: 'issues' },
    { label: 'News & Media', href: 'news-media', page: 'news' },
    { label: 'Engagement', href: 'engagement', page: 'engagement' },
    { label: 'Get Involved', href: 'get-involved', page: 'get-involved' },
    { label: 'Contact', href: 'contact', page: 'contact', cta: true }
  ];
  ...
  const SEAL_SVG =
    '<svg viewBox="0 0 64 64" role="img" aria-label="Seal of the Office of the Chairman">' +
      '<circle cx="32" cy="32" r="30" fill="#052A19"/>' +
      ...
      '</g>' +
      '<text x="32" y="39" font-family="Georgia, serif" font-weight="700" font-size="16" fill="#F6FAF7" text-anchor="middle">PLS</text>' +
    '</svg>';
        ...
        '<div class="footer__top">' +
          ...
          '<div>' +
            ...
            '<nav class="footer__links" aria-label="More links">' +
              ...
              '<a href="engagement">Committees &amp; Engagement</a>' +
